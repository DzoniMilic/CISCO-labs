...
Three Layer 2 switches wired into a triangle, which is one physical loop. 
Rapid PVST+ elect a root bridge and clicks exactly one port to break the loop, leaving the redudant link ready to take over. Companion lab for: 
- [Spanning Tree Protocol 9Rapid PVST+) Configuration on Cisco Switches] ](https://computingforgeeks.com/cisco-spanning-tree-protocol-configuration/)
