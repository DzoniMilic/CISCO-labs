...
Spanning Tree treats the bundle as a single link, so both members forwarded at once instead of one being blocked. Companion lab for:
...
There is no '.pkt' file: Packet Tracer's format cannot be generated outside the app. Build the two switches, wire Gi0/0-Gi0/0 and Gi0/3-Go0/3, then paste.
